...
$IP = Read-Host "Please specify IP range to scan such as '192.168.0.*'"
$list_of_AD_computers = Get-ADComputer -Properties Name, IPv4Address -Filter * | where {$_.ipv4address -like $IP } 
